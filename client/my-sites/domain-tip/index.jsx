...
class DomainTip extends React.Component {
	...
	render() {
		...
		let message = this.props.translate( 'Purchase a custom domain for your site.' );

		if ( this.props.hasDomainCredit ) {
			message = this.props.translate( 'Your plan includes a free custom domain. Grab this one!' );
		}
...
export default connect( ( state, ownProps ) => {
	...
	const isIneligible = ! site || ! siteSlug || site.jetpack;
